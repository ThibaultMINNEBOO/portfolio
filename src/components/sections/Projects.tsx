      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="flex flex-wrap gap-2 mb-12">
          <button
            ...
            className={`rounded-full px-4 py-2 font-code text-xs font-medium border transition-all duration-300
              ${
                activeFilter === null
        ...
        <div className="mt-12 text-center">
          <a
            ...
            className="inline-flex items-center gap-3 rounded-xl border border-white/10 bg-white/5 px-8 py-3.5 font-heading font-bold text-neutral-200 transition-all duration-300 hover:bg-white/10 hover:border-white/20 hover:scale-105"
          >
